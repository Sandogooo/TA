...
//mengambil data dari tabel
    $cekuser2 = mysql_query("select * from booking where Namatim='$Namatim' and Status='lunas'");
...
$judul = "DATA BOOKING USER DAFEST FUTSAL";
...
$pdf->Output();
	...
	echo"<script language=\"javascript\">alert(\"Proses Gagal , Status Belum Lunas\"); document.location.href='info_penyewaan.php';</script>";
}
?>
