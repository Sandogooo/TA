	...
	<body class="no-trans">
									...
									<div class="container-fluid">
										...
										<div class="collapse navbar-collapse scrollspy smooth-scroll" id="navbar-collapse-1">
											<ul class="nav navbar-nav navbar-right">
												...
												<li><a href="t_bookingmember.php">Jadwal Sewa</a></li>
												<li><a href="#pb">Pembayaran</a></li>
												<!-- <li><a href="#kontak">Pembayaran</a></li>-->
												<li class="dropdown">
       										     <a class="dropdown-toggle" data-toggle="dropdown" href="#">
      										     <span class="caret"></span></a>
        										<ul class="dropdown-menu">
         										 <li><a href="info_member.php">Info Member</a></li>
         										 <li><a href="info_penyewaanmember.php">Data Sewa</a></li>
						...
						<div class="row">
							...
							<div class="col-md-6">
								...
								<ul class="list-unstyled">
									...
									<li><i class="fa fa-caret-right pr-10 text-colored"></i> Cafe dan Wi-Fi</li>
		...
		<!-- section end -->
			...
			<div class="footer section">
				<div class="container">
					<h1 class="title text-center" id="pb">Proses Pembayaran</h1>
					<p><h4>*Pembayaran Dilakukan dengan cara:</p>
					      <p>-mengirim screenshoot/gambar struk transfer ke rekening dibawah sesuai dengan harga daftar member</p>
					      <p>-Membayar Langsung ke Dafest Futsal</p>
					<p>*Batas Pembayaran 1 hari setelah akun dibuat, jika tidak maka kami akan menghapus data member anda</p></h4>
					<div class="row">
						<div class="col-sm-6">
								<ul class="list-icons">
