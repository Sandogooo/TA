...
//mengambil data dari tabel
    $cekuser2 = mysql_query("select * from booking where Namatim='$Namatim' and Status='member' or Status='lunas'");
...
$pdf->Output();
	...
	echo"<script language=\"javascript\">alert(\"Proses Gagal , Status Belum Lunas\"); document.location.href='t_bookingadm.php';</script>";
}
?>
